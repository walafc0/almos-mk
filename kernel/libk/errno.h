/*
 * errno.h - list of all error codes used by the kernel
 *
...
#define EUNKNOWN        123	/* Unknown error */
#define EBADBLK         124     /* Bad block */
#define EEODIR          125	/* End of Directory */
#define ENOTSUPPORTED   126     /* Asked service is not supported */
...
#define ENOMEDIUM	131	/* No medium found */
#define EMEDIUMTYPE	132	/* Wrong medium type */
#define	ECANCELED	133	/* Operation Canceled */
#define __SYS_NERR  ((ECANCELED) + 1)
