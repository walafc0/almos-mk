...
#ifdef HAVE_TLS
#error this version does not support TLS
...
extern int gomp_iter_dynamic_next_locked (long *, long *);
extern int gomp_iter_guided_next_locked (long *, long *);
...
extern int gomp_iter_ull_static_next (unsigned long long *,
				      unsigned long long *);
extern int gomp_iter_ull_dynamic_next_locked (unsigned long long *,
					       unsigned long long *);
extern int gomp_iter_ull_guided_next_locked (unsigned long long *,
					     unsigned long long *);
...
static inline void gomp_finish_task (struct gomp_task *task)
{
...
extern void gomp_init_work_share (struct gomp_work_share *, int, unsigned);
extern void gomp_fini_work_share (struct gomp_work_share *);
extern int gomp_work_share_start (int);
